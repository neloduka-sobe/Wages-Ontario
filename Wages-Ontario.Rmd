...
**Conclusions**:
1. The graph shows a steady increase in the number of employees.
2. In 2000, there were just over 10,000 employees.
3. By 2020, the number had risen to approximately 13,000 employees.
4. Plot shows an unusual number of employment reduction in 2008.
>>>>>>> main
