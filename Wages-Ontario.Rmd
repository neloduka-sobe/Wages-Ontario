...
full_time_part_time <- wages %>% filter(Age.group %in% c("15-24 years", "25-54 years", "55 years and over")) %>% group_by(Age.group, Type.of.work) %>% summarise(Employees = sum(Both.Sexes))
